...
issue](https://github.com/cisagov/ansible-role-disable-numa/issues) in
...
request](https://github.com/cisagov/ansible-role-disable-numa/pulls),
...
```console
cd ansible-role-disable-numa
pyenv virtualenv <python_version_to_use> ansible-role-disable-numa
pyenv local ansible-role-disable-numa
